...
This directory contains the Go reference implementation of the ABOM scheme (Figure 5 in the proceedings version, Figure 10 of the full version linked above). We instantiate the scheme with HKDF-SHA256 and AES-CBC.
